...
public class jumlahHari {
    public static void main(String[] args) {
        ...
        switch (bulan.toLowerCase()){ //mengevaluasi bulan dan mengubah/membaca sesuai input user apakah huruf kapital atau huruf kecil
            ...
            case "desember": //ekspresi adalh desember
                ...
                break; //menghentikan secara paksa proses switch setelah case cocok
            default: bulan = "invalid data"; //jika tidak ada input yang cocok dengan salah satu case,maka akan mencetak invalis data
            break; //menghentikan secara paksa proses switch setelah case cocok
        }
